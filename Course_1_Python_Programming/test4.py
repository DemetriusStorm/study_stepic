...
# The function should return a dictionary of key/value pairs where every key is a word
...
# should print 1
# ======================================================================
# Create a function named count_first_letter that takes a dictionary named names as a parameter. names
# should be a dictionary where the key is a last name and the value is a list of first names.
